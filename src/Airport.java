...
public class Airport {
    ...
    public static void main(String[] args) {
        ...
        BlockingQueue<Gate> refuelRequestQueue = new ArrayBlockingQueue<>(10);

        Gate gate1 = new Gate(1, refuelRequestQueue);
        Gate gate2 = new Gate(2, refuelRequestQueue);
        Gate gate3 = new Gate(3, refuelRequestQueue);
